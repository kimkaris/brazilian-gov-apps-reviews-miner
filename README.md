...
## How to Run
- Make sure you have Python installed. I highly recommend that you create and activate a virtual environment. Then, install the required dependencies:
```bash
...
* [Original methodology repository](https://github.com/HumaniSELab/An_Analysis_of_Privacy_Regulations_and_User_Concerns_of_Finance_Mobile_Applications)
